...
var timeouts = process.env.DEBUG ? 99999999 : 10000;
exports.config = {
  //
  // ====================
  ...
  before: function (capabilities, specs) {
    ...
    browser.addCommand("waitAndClick", function (selector) {
      try {
        $(selector).waitForDisplayed(3500);
        $(selector).click();
      } catch (Error) {
        throw new Error("Could not on click on selector: " + $(selector));
      }
    });
